            ...
            <div class="collapse navbar-collapse ml-3" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item {{ Request::is('index') ? 'active bg-white rounded-lg' : '' }}">
                        <a class="nav-link" href="/support/index"><i class="fa fa-home"></i> Home <span
...
@include('support.modal.add_project')

<script>
    $(document).ready(function () {
        var username = $.cookie('username');
        $('#username').html($.cookie('username'));
        $('.checkin').append('<a class="nav-link" href="/support/checkin='+username+'"><i class="fas fa-qrcode"></i>Check-In</a>');
    });
