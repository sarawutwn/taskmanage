...
<div class="col-lg-12 px-0">
    ...
    <script>
        ...
        function paginate(page) {
            ...
            $.ajax({
                type: 'GET',
                url: '/api/project/member/case/AdminPaginateCaseByTokenWithViewMake?page='+page,
                dataType: 'json',
                headers: {
        ...
        function paginateProject(page) {
            ...
            $.ajax({
                type: 'GET',
                url: '/api/project/AdminPaginateByTokenWithViewMake?page='+page,
                dataType: 'json',
                headers: {
                    'Authorization': 'Bearer '+token,
                },
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/api/project/member/case/AdminPaginateCaseByTokenWithViewMake',
                dataType: 'json',
                headers: {
                    'Authorization': 'Bearer '+token,
                },
            ...
            $.ajax({
                type: 'GET',
                url: '/api/project/AdminPaginateByTokenWithViewMake',
                dataType: 'json',
                headers: {
                    'Authorization': 'Bearer '+token,
                },
